...
public class City {
	...
	public String googleMap(String from, String to, String method){
		...
		if ((from.equals("Mao") && to.equals("Es Castell")) || (from.equals("Es Castell") && to.equals("Mao"))){ 
			if (method.equals("car"))
		...
		if ((from.equals("Mao") && to.equals("Ciutadella")) || (from.equals("Ciutadella") && to.equals("Mao"))){ 
			if (method.equals("car"))
