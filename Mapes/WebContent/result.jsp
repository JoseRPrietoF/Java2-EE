...
<body>
	...
	Integer x2 = (Integer)request.getAttribute("x2");
	Integer y2 = (Integer)request.getAttribute("y2");
	...
	center X : <%= centerX %>
	center Y : <%= centerY %>
	<iframe width='625' height='500' frameborder='0' scrolling='no' marginheight='0' marginwidth='0' src='http://ide.cime.es/visorIDE/Iframe.aspx?wkid=25831&x=<%=centerX %>&y=<%=centerY %>&zoom=6&srv=http%3A%2F%2Fide.cime.es%2FCache%2FIDEMenorca%2Fbaserefcatxe%2F_alllayers%2CWmsVacio.ashx&capas=%2C0&trans=1%2C0&tit=%2C'></iframe>
